    ...
    <section class="topbar-card">
      <div class="topbar-row">
        ...
        <div class="topbar-actions">
          <button id="saveCheckpointBtn" class="text-action primary" title="保存" aria-label="保存">保存</button>
          <button id="restoreLatestBtn" class="text-action" title="恢复" aria-label="恢复">恢复</button>
          <details class="more-menu">
            <summary class="text-action" aria-label="更多操作" title="更多操作">更多</summary>
